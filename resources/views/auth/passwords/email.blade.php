        ...
        <div class="row">
            <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12 col-xs-12 mx-auto my-60">
                <div class="p-80 login-background">
                    <div class="pb-4">
                        <h5 class="font-35 font-weight-bold">Forget Password</h5>
                    </div>
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="">
                            <p class="text-medium font-20">Enter your email</p>
                                ...
                                <div class="clearfix">
                                    ...
                                    <div class="float-right py-2">
                                        <button type="submit" class="btn blue-btn text-white">Send</button>
                                    </div>
                                </div>
                               <!--  <div class="clearfix">
                                    <div class="float-left mt-3">
                                        <p><a class="register-text text-decoration-none" href="{{url('login')}}">Login</a></p>
                                    </div>
                                </div> -->
