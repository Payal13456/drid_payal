                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-xs-12 mt-4">
                        <div class="card hovercard">
                            ...
                            <div class="info">
                                <div class="desc text-dark mt-0">ID: #DRID0123456 
                                    <i class="fa fa-clone id-copy-icon"></i>
                                </div>
                                <div class="title">
                                    <a target="#" href="#">Jaydon Bergson</a>
                                </div>
                                ...
                                <div class="desc-2">
                                    <div class="clearfix">
                                        ...
                                        <div class="float-left intro-text">
                                            <a class="contact-desc">+1-123457890</a>
                                        </div>
                                    </div>
                                    <!--  -->
                                    <div class="clearfix">
                                    ...
                                    <div class="clearfix">
                                        ...
                                        <div class="float-left intro-text">
                                            <a class="contact-desc">jaydon.bergson@gmail.com</a>
                                        </div>
                                    </div>
                                    <!--  -->
                                    <div class="clearfix">
